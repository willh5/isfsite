    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, default=None, to="isfsite.location"
                    ),
                ),
                (
                    "currency",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "most_common_scope_source",
                    models.BooleanField(blank=True, default=False),
                ),
                (
                    "scope_source_cleaned",
                    models.CharField(blank=True, max_length=100, null=True),
                ),
                (
                    "scp3_pcnt_from_other_sources",
                    models.DecimalField(decimal_places=2, max_digits=10, null=True),
                ),
                (
                    "scp3_most_common_source",
                    models.BooleanField(blank=True, default=False),
                ),
                (
                    "value",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scheme",
                    models.CharField(
                        choices=[("LOC", "loc"), ("MKT", "mkt"), ("NONE", "none")],
                        default="NONE",
                        max_length=10,
                    ),
                ),
        ...
        migrations.AddConstraint(
            model_name="isin",
            constraint=models.UniqueConstraint(fields=("name",), name="unique-isin"),
        ),
        migrations.AddConstraint(
            model_name="location",
        ...
        migrations.AddIndex(
            model_name="qual",
            index=models.Index(
                fields=["location"], name="isfsite_qua_locatio_d74288_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="qual",
            index=models.Index(
                fields=["metric"], name="isfsite_qua_metric__ac0050_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="qual",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("date", "numerator", "denominator", "firm"),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["publication_date"], name="isfsite_tar_publica_771041_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="ticker",
        ...
        migrations.AddIndex(
            model_name="scope3",
            index=models.Index(
                fields=["location"], name="isfsite_sco_locatio_0ac2fa_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="scope3",
            index=models.Index(
                fields=["metric"], name="isfsite_sco_metric__360de1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="scope3",
        ...
        migrations.AddIndex(
            model_name="scope2",
            index=models.Index(
                fields=["location"], name="isfsite_sco_locatio_7e1c19_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="scope2",
            index=models.Index(
                fields=["metric"], name="isfsite_sco_metric__8ff06c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="scope2",
        ...
        migrations.AddIndex(
            model_name="scope1",
            index=models.Index(
                fields=["location"], name="isfsite_sco_locatio_9c8e21_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="scope1",
            index=models.Index(
                fields=["metric"], name="isfsite_sco_metric__322e84_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="scope1",
        ...
        migrations.AddIndex(
            model_name="quant",
            index=models.Index(
                fields=["location"], name="isfsite_qua_locatio_bf8adb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="quant",
            index=models.Index(
                fields=["metric"], name="isfsite_qua_metric__1cd122_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="quant",
