        ...
        <>
            <div className='p-5 bg-light'>
                <div className='bg-white shadow border'>
                    ...
                    <input type="search" value={searchText} onChange={e=> setSearchText(e.target.value)} placeholder="Search firm name" />
                    ...
                    <input type="search" value={searchText2} onChange={e=> setSearchText2(e.target.value)} placeholder="Filter by country name" />
                    <table className='table'>
                        <thead class="bg-gray-50 border-b-2 border-gray-200">
                            <tr>
                                <th class="p-3 text-sm tracking-wide text-left">name</th>
                                <th class="p-3 text-sm tracking-wide text-left">sector</th>
                                <th class="p-3 text-sm tracking-wide text-left">hq location</th>
                                <th></th>
                                <th></th>
                                <th></th>
                                <th></th>
                        ...
                        <tbody>
                            {data.map((d,i) => (
                                <tr key={i}>
                                    <td class="p-1 text-sm text-center text-gray-700">{d.name}</td>
                                    <td class="p-1 text-sm text-center text-gray-700">{d.sector}</td>
                                    <td class="p-1 text-sm text-center text-gray-700">{d.hq_location}</td>
                 ...
                 {selected &&
                     <div>{datatype === 1 ? ( <button class="bg-gray-400  text-gray-800 py-1 px-1 rounded inline-flex items-center" onClick={() => {setDatatype("1"); setNeedFetch("1") }}>Scope 1</button> )
                     :  ( <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 py-1 px-1 rounded inline-flex items-center" onClick={() => {setDatatype("1"); setNeedFetch("1") }}>Scope 1</button> )}
                        <span> | </span>
                        <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 py-1 px-1 rounded inline-flex items-center" onClick={() => {setDatatype("2"); setNeedFetch("1") }}>Scope 2</button>
                        <span> | </span>
                        <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 py-1 px-1 rounded inline-flex items-center" onClick={() => {setDatatype("3"); setNeedFetch("1")} }>Scope 3</button>
                        <span> | </span>
                        <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 py-1 px-1 rounded inline-flex items-center" onClick={() => {setDatatype("4"); setNeedFetch("1")} }>Targets</button>
