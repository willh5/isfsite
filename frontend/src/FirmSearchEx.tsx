...
const fetchSectorData = async() => {
    ...
    const fetchData = async() => {
        ...
        const endpoint = `http://willh1.pythonanywhere.com/api/firms/?name__icontains=${searchText}&sector__id__iexact=${sectorID}`
